...
from models.layers.utils import get_filter
...
class MultiWaveletCross(nn.Module):
    ...
    def __init__(self, in_channels: object, out_channels: object, seq_len_q: object, seq_len_kv: object, modes: object, c: object = 64,
                 k: object = 8, ich: object = 512,
                 L: object = 0,
                 base: object = 'legendre',
                 mode_select_method: object = 'random',
                 initializer: object = None, activation: object = 'tanh',
                 kwargs: object = None) -> object:
